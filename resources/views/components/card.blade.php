<div class="card" style="width: 250px; height: 400px; border: 1px solid #ddd; border-radius: 8px; box-shadow: 4px 4px 16px rgba(0, 0, 0, 0.1); overflow: hidden; background-color: #fff; transition: transform 0.2s ease-in-out; margin: 16px;">
    @if (!empty($image))
    ...
    @endif
    <div class="card-content" style="padding: 5 px; text-align: center;">
        <h3 class="card-title" style="font-size: 18px; font-weight: bold; color: #333; margin-bottom: 10px;">{{ $title }}</h3>
